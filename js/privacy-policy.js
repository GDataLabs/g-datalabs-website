...
var data = ""
var i = 0;
$("#form-privacy-policy").submit(async (e) => {
    e.preventDefault()
    $("#generate-privacy-policy-btn > span").text("Generating")
    $("#generate-privacy-policy-btn .typing").removeClass("d-none")
    $("#generate-privacy-policy-btn").prop("disabled", true);
...
function typeWriter() {
    if (i < data.length) {
      ...
      requests = []
      section++
      $("#generate-privacy-policy-btn > span").text("Generate")
      $("#generate-privacy-policy-btn .typing").addClass("d-none")
      $("#generate-privacy-policy-btn").prop("disabled", false);
