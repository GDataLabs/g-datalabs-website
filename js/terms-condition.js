...
var data = ""
var i = 0;
$("#form-terms-condition").submit(async (e) => {
    e.preventDefault()
    $("#generate-terms-condition-btn > span").text("Generating")
    $("#generate-terms-condition-btn .typing").removeClass("d-none")
    $("#generate-terms-condition-btn").prop("disabled", true);
...
function typeWriter() {
    if (i < data.length) {
      ...
      requests = []
      section++
      $("#generate-terms-condition-btn > span").text("Generate")
      $("#generate-terms-condition-btn .typing").addClass("d-none")
      $("#generate-terms-condition-btn").prop("disabled", false);
